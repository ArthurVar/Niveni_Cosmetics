                                ...
                                user.orders.map((item, idx) => (
                                    <div className='profile__orders' key={idx}>
                                        ...
                                        </ul>
                                        {
                                            ...
                                            <ul className='profile__orders-list'>
                                                {
                                                    item.cosmetics.map(el => (
                                                        <li className='profile__orders-item ' key={el.id}>
                                                            <img className='profile__orders-image' src={el.imge} alt=""/>
                                                            <p className='profile__orders-info'>{t("profile.name")} : <br/> <span className='profile__orders-span'>{el.title}</span> </p>
                                                            <p className='profile__orders-info'>{t("profile.category")} : <br/> <span className='profile__orders-span'>{el.category}</span> </p>
                                                            <p className='profile__orders-info'>{t("profile.inStock")} :  <br/> <span className='profile__orders-span'>{el.count}</span></p>
                                                            <p className='profile__orders-info'>{t("profile.price")} : <br/> <span className='profile__orders-span'>{el.price}$</span> </p>
                                                        </li>
                                                    ))
                                                }
                                            </ul>
